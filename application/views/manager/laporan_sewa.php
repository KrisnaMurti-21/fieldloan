        ...
        <div class="row">
            <div class="col-lg-12 col-12 mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <form class="form mt-5" method="POST" action="<?php echo site_url('admin/Manager/laporancari/') ?>">
                                <div class="row">
                                    <?php
    ...
    <div class="container">
        ...
        <?php if (isset($tgl_mulai) && isset($tgl_akhir)) { ?>
            <div class="row">
                ...
                <div class="col-md-2">
                    <form class="form mt-5" method="POST" action="<?php echo site_url('admin/Manager/cetak_laporan/') ?>" target="_blank">
                        <div class="row">
                            <div class="col-md-5">
