        ...
        <div class="col-lg-12">
            <div class="row">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <form method="POST" action="<?php echo site_url('Sewa/v_sewa') ?>">
                                                        ...
                                                        <button type="submit" class="btn btn-primary btn-sm rounded-pill tombolkirim">
                                                            <?php echo $val->jam; ?>
                                                        </button>
                                                    </form>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-header">
                            <form class="form" method="POST" action="<?php echo site_url('Sewa/jadwalcari/' . $lapangan->id_lapangan) ?>">
                                <div class="row">
                                    <input type="hidden" name="id_lapangan" value="<?php echo $lapangan->id_lapangan; ?>">
                                    <div class="col-md-9">
                                        <?php
                                        if (isset($tgl)) { ?>
                                            <input type="date" class="form-control datepicker" name="tanggal_input" value="<?php echo $tgl; ?>">
                                        <?php } else { ?>
